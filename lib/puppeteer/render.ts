...
// Renders a self-contained HTML document to a JPEG preview at the exact format
// size. On render timeout it captures whatever rendered rather than failing.
async function renderOnce(html: string, size: RenderSize): Promise<Uint8Array> {
